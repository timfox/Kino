...
def res2s_video_denoising_loop(  # noqa: PLR0913
    sigmas: torch.Tensor,
    video_state: LatentState | None,
    audio_state: LatentState | None,
    stepper: DiffusionStepProtocol,
    ...
    """Video-only res2s loop (audio_state ignored). Used when GOPEX skip_audio / --skip-audio."""
    return res2s_audio_video_denoising_loop(
        ...
        noise_seed_substep=noise_seed_substep,
        eta=eta,
        bongmath=bongmath,
