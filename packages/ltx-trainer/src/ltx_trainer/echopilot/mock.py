"""Runnable evaluation smoke for echopilot (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    return {"paper": "arXiv:2605.25944", "memory_tokens": getattr(cfg, "memory_tokens", 32), "seed_frames": getattr(cfg, "num_seed_frames", 3)}
