...
def evaluation_smoke() -> dict[str, Any]:
    from ltx_trainer.tqcodec.metrics import table1_codec_comparison

    try:
        result = table1_codec_comparison()
    except TypeError:
        result = table1_codec_comparison  # constant or needs manual wiring
        if callable(result):
            raise
