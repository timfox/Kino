"""Runnable evaluation smoke for clear (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    return {
        "paper": getattr(cfg, "paper_arxiv", "arXiv:2605.25941"),
        "wan_nudity_erased_f1_stub": 0.92,
        "layer_gamma": getattr(cfg, "gamma", 1.0),
    }
