"""Runnable evaluation smoke for maca (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    ...
    arch = layout.architecture_layout()
    return {
        "paper": "arXiv:2605.25746",
        "graphspec_keys": len(arch["GraphSpec"]),
        "budget_tokens": getattr(cfg, "budget_tokens", 4096),
    }
