"""Runnable evaluation smoke for r5dgs (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    ...
    rot = float(np.linalg.norm(q))
    return {"paper": "arXiv:2605.25909", "quaternion_norm": round(rot, 4)}
