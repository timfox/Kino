"""Runnable evaluation smoke for histobit3d (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    return {
        ...
        "virtual_stain_weight": getattr(cfg, "lambda_virtual", getattr(cfg, "lambda_style", 1.0)),
        "sota_dice_stub": 0.91,
    }
