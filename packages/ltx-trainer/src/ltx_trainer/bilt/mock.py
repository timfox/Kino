"""Runnable evaluation smoke for bilt (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    return {
        ...
        "scanner_tokens": getattr(cfg, "max_scan_tokens", 512),
        "synthetic_ratio": getattr(cfg, "synthetic_mix_ratio", 0.5),
    }
