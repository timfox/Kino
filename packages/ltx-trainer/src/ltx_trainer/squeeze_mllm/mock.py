"""Runnable evaluation smoke for squeeze_mllm (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    return {"paper": "arXiv:2605.26111", "dla_stages": getattr(cfg, "num_dla_stages", 3)}
