"""Runnable evaluation smoke for deltacam (arXiv stub)."""
...
def _NUMPY_FALLBACK(cfg: Any) -> dict[str, Any]:
    layout = load_sibling(__file__, "layout")
    spec = layout.conditioning_layout(height=64, width=64, num_intrinsics=8)
    return {
        "paper": "arXiv:2605.25266",
        "plucker_channels": spec["plucker_ray_map"]["shape"][-1],
        "num_limitations": len(layout.paper_limitations()),
    }
